...
Version  : 1.3.242
Release  : 106
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.242/Vulkan-Tools-1.3.242.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.242/Vulkan-Tools-1.3.242.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.242
cd %{_builddir}/Vulkan-Tools-1.3.242
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677549343
mkdir -p clr-build
pushd clr-build
