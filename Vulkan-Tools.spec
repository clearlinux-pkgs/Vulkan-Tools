...
Version  : 1.3.231
Release  : 100
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.231/Vulkan-Tools-1.3.231.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.231/Vulkan-Tools-1.3.231.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.231
cd %{_builddir}/Vulkan-Tools-1.3.231
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665760657
mkdir -p clr-build
pushd clr-build
