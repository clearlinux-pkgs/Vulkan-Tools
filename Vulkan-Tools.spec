...
Version  : 1.3.208
Release  : 77
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.208/Vulkan-Tools-1.3.208.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.208/Vulkan-Tools-1.3.208.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.208
cd %{_builddir}/Vulkan-Tools-1.3.208
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647450380
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Tools-1.3.208/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Tools/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/Vulkan-Tools-1.3.208/windows-runtime-installer/VulkanRT-License.txt %{buildroot}/usr/share/package-licenses/Vulkan-Tools/84fbabc68c29007b8b7762962b0bba1137648f5e
pushd clr-build
%make_install
popd
