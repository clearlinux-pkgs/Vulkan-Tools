...
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.229/Vulkan-Tools-1.3.229.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.229
cd %{_builddir}/Vulkan-Tools-1.3.229
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663890550
mkdir -p clr-build
pushd clr-build
