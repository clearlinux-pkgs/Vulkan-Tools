...
Version  : 1.3.230
Release  : 99
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.230/Vulkan-Tools-1.3.230.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.230/Vulkan-Tools-1.3.230.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.230
cd %{_builddir}/Vulkan-Tools-1.3.230
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664561234
mkdir -p clr-build
pushd clr-build
