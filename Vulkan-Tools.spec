...
Version  : 1.3.251
Release  : 115
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.251/Vulkan-Tools-1.3.251.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.251/Vulkan-Tools-1.3.251.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.251
cd %{_builddir}/Vulkan-Tools-1.3.251
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685661209
mkdir -p clr-build
pushd clr-build
