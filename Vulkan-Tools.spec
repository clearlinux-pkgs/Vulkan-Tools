...
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.4.315/Vulkan-Tools-1.4.315.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.4.315
cd %{_builddir}/Vulkan-Tools-1.4.315
pushd ..
cp -a Vulkan-Tools-1.4.315 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747074873
mkdir -p clr-build
pushd clr-build
