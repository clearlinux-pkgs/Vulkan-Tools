...
Version  : 1.3.226
Release  : 95
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.226/Vulkan-Tools-1.3.226.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.226/Vulkan-Tools-1.3.226.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.226
cd %{_builddir}/Vulkan-Tools-1.3.226
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662079173
mkdir -p clr-build
pushd clr-build
