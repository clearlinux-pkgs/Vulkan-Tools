...
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.227/Vulkan-Tools-1.3.227.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.227
cd %{_builddir}/Vulkan-Tools-1.3.227
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662861062
mkdir -p clr-build
pushd clr-build
