...
Version  : 1.3.241
Release  : 105
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.241/Vulkan-Tools-1.3.241.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.241/Vulkan-Tools-1.3.241.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.241
cd %{_builddir}/Vulkan-Tools-1.3.241
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677001764
mkdir -p clr-build
pushd clr-build
