...
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.4.319/Vulkan-Tools-1.4.319.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.4.319
cd %{_builddir}/Vulkan-Tools-1.4.319
pushd ..
cp -a Vulkan-Tools-1.4.319 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750690787
mkdir -p clr-build
pushd clr-build
