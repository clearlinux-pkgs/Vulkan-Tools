...
Version  : 1.3.223
Release  : 92
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.223/Vulkan-Tools-1.3.223.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.223/Vulkan-Tools-1.3.223.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.223
cd %{_builddir}/Vulkan-Tools-1.3.223
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659052258
mkdir -p clr-build
pushd clr-build
