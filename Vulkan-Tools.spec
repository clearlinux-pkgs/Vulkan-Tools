...
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.228/Vulkan-Tools-1.3.228.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.228
cd %{_builddir}/Vulkan-Tools-1.3.228
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663348789
mkdir -p clr-build
pushd clr-build
