...
Version  : 1.3.235
Release  : 101
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.235/Vulkan-Tools-1.3.235.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.235/Vulkan-Tools-1.3.235.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.235
cd %{_builddir}/Vulkan-Tools-1.3.235
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668738100
mkdir -p clr-build
pushd clr-build
