...
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.225/Vulkan-Tools-1.3.225.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.225
cd %{_builddir}/Vulkan-Tools-1.3.225
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661196123
mkdir -p clr-build
pushd clr-build
