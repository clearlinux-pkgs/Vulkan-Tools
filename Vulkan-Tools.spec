...
Version  : 1.3.236
Release  : 102
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.236/Vulkan-Tools-1.3.236.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.236/Vulkan-Tools-1.3.236.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.236
cd %{_builddir}/Vulkan-Tools-1.3.236
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670263620
mkdir -p clr-build
pushd clr-build
