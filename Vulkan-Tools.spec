...
Version  : 1.3.224
Release  : 93
URL      : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.224/Vulkan-Tools-1.3.224.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Tools/archive/v1.3.224/Vulkan-Tools-1.3.224.tar.gz
...
%prep
%setup -q -n Vulkan-Tools-1.3.224
cd %{_builddir}/Vulkan-Tools-1.3.224
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659714657
mkdir -p clr-build
pushd clr-build
